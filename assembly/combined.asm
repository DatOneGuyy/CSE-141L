...
#program-2-pairs
    ...
    #difference-loop-start
        ...
        cmp r6 r0 //if r6 > r0, stored minimum is smaller
        jumplt #larger-current
...
#subtract
    ...
    //detect carry in LSB
    imm r3 1
    cmp r7 r3 //sum of zero indicates a carry
    jumplt #lsb-negation-carry
    jump #no-lsb-negation-carry

    #lsb-negation-carry
    add r3 r6 //add 1 to MSB
    copy r6

    #no-lsb-negation-carry
    //begin addition of n1 + (-n2)
    //add lsb
    add r5 r7
    copy r1
    ...
    //if carry occurred, r1 < r5
    cmp r1 r5
    jumplt #lsb-subtraction-carry
    jump #no-lsb-subtraction-carry

    #lsb-subtraction-carry
    //add 1 to msb sum
    add r0 r3

    #no-lsb-subtraction-carry
    return
...
#merge
    ...
    #merge-loop-start
        ...
        //if r0 < r1, right is negative and left is positive
        cmp r0 r1
        jumplt #smaller-right-msb

        //if r1 < r0, right is positive and left is negative
        cmp r1 r0
        jumplt #smaller-left-msb

        // If signs are equal, compare the full MSBs (r6 = left MSBs, r7 = right MSBs)
        cmp r6 r7
        jumplt #smaller-left-msb
