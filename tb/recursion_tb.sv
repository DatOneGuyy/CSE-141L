...
function void display_stack(input logic [3:0] pointer);
    $display("Stack: [%d, %d, %d, %d, %d, %d], pc: %d, valid: %d, pointer: %d", dut.stack_inst.stack[pointer].r2, dut.stack_inst.stack[pointer].r3, dut.stack_inst.stack[pointer].r4, dut.stack_inst.stack[pointer].r5, dut.stack_inst.stack[pointer].r6, dut.stack_inst.stack[pointer].r7, dut.stack_inst.stack[pointer].pc, dut.stack_inst.valid, dut.stack_inst.pointer);
endfunction
